...
import {
  default as fullMindMap,
  shallow,
  ImageProcessing,
  SpatialImageProcessing,
} from './mindMap.js';
...
## Images are contiguous functions of space
...
<MindMap map={SpatialImageProcessing} width={1200} height={800} />
...
<Morphology
  src="assets/dark_windows_eq.jpg"
...
Image pyramid image ©
[opencv dev team](https://docs.opencv.org/4.0.1/d4/d1f/tutorial_pyramids.html)
...
Buiding image, Xue Sheng Xi Lu, Shenzhen Shi, China
[on unsplash](https://unsplash.com/photos/sKKuyRyiy6k)
